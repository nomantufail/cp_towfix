        ...
        <div id="request_form_model_{{$request->id}}" class="modal fade" role="dialog">
            <div class="modal-dialog vehicle-detail-popup">
                ...
                <div class="modal-content">
                    ...
                    <form class="add-vehicle-form" method="post" @if($document == null && $request->franchise_id == $user->id)action="{{url('/vehicle')}}/{{$request->vehicle->id}}/add_document" @else onsubmit="return false" @endif >
                        {{csrf_field()}}
                        <input type="hidden" name="cust_vehicle_srv_reqs_id" value="{{$request->id}}">
                        <div class="add-vehicle-widget">
                            <label>
                                <span>Name</span>
                                <input @if($document != null) disabled @endif type="text" name="document[simpleInformation][name]" placeholder="Name" value="@if($document != null) {{$document->simpleInformation->name}} @endif">
                            </label>

                            <label class="half-field">
                                <span>Make/Year</span>
                                <input @if($document != null) disabled @endif type="text" id="datetimepicker" name="document[simpleInformation][make_year]" placeholder="Make/Year" value="@if($document != null) {{$document->simpleInformation->make_year}} @endif">
                            </label>
                            ...
                            <label class="half-field">
                                <span>Rego</span>
                                <input @if($document != null) disabled @endif type="tel" name="document[simpleInformation][rego]" placeholder="Rego" value="@if($document != null) {{$document->simpleInformation->rego}} @endif">
                            </label>
                            <label class="half-field">
                                <span>Date</span>
                        ...
                        <div class="vehicles-service-list">
                            <table class="customer-table" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][lh_indicator]" value="@if($document != null) {{$document->comment->lh_indicator}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][rh_indicator]" value="@if($document != null) {{$document->comment->rh_indicator}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][no_plate_light]" value="@if($document != null) {{$document->comment->no_plate_light}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][water_tank_mounts]" value="@if($document != null) {{$document->comment->water_tank_mounts}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][hand_brake]" value="@if($document != null) {{$document->comment->hand_brake}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][trailer_plug]" value="@if($document != null) {{$document->comment->trailer_plug}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][wiring_loom]" value="@if($document != null) {{$document->comment->wiring_loom}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][springs_hangers]" value="@if($document != null) {{$document->comment->springs_hangers}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][u_bolts]" value="@if($document != null) {{$document->comment->u_bolts}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][a_frame]" value="@if($document != null) {{$document->comment->a_frame}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][stabiliser_jacks]" value="@if($document != null) {{$document->comment->stabiliser_jacks}} @endif" > </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][chassis_welds]" value="@if($document != null) {{$document->comment->chassis_welds}} @endif"> </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input @if($document != null) disabled @endif type="text" name="document[comment][safety_chains]" value="@if($document != null) {{$document->comment->safety_chains}} @endif" > </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="vehicles-service-list">
                            <table class="customer-table" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>RHR</td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][wheel_cylinders]" value="@if($document != null) {{$document->detail->rhr->wheel_cylinders}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][wheel_bearings]" value="@if($document != null) {{$document->detail->rhr->wheel_bearings}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][break_shoes]" value="@if($document != null) {{$document->detail->rhr->break_shoes}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][brake_magnet]" value="@if($document != null) {{$document->detail->rhr->brake_magnet}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][hub_wear]" value="@if($document != null) {{$document->detail->rhr->hub_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][tyre_wear]" value="@if($document != null) {{$document->detail->rhr->tyre_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhr][tyre_psi]" value="@if($document != null) {{$document->detail->rhr->tyre_psi}} @endif" placeholder="Details"> </td>
                                </tr>

                                <tr>
                                    <td>RHF</td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][wheel_cylinders]" value="@if($document != null) {{$document->detail->rhf->wheel_cylinders}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][wheel_bearings]" value="@if($document != null) {{$document->detail->rhf->wheel_bearings}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][break_shoes]" value="@if($document != null) {{$document->detail->rhf->break_shoes}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][brake_magnet]" value="@if($document != null) {{$document->detail->rhf->brake_magnet}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][hub_wear]" value="@if($document != null) {{$document->detail->rhf->hub_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][tyre_wear]" value="@if($document != null) {{$document->detail->rhf->tyre_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][rhf][tyre_psi]" value="@if($document != null) {{$document->detail->rhf->tyre_psi}} @endif" placeholder="Details"> </td>
                                </tr>

                                <tr>
                                    <td>LHR</td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][wheel_cylinders]" value="@if($document != null) {{$document->detail->lhr->wheel_cylinders}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][wheel_bearings]" value="@if($document != null) {{$document->detail->lhr->wheel_bearings}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][break_shoes]" value="@if($document != null) {{$document->detail->lhr->break_shoes}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][brake_magnet]" value="@if($document != null) {{$document->detail->lhr->brake_magnet}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][hub_wear]" value="@if($document != null) {{$document->detail->lhr->hub_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][tyre_wear]" value="@if($document != null) {{$document->detail->lhr->tyre_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhr][tyre_psi]" value="@if($document != null) {{$document->detail->lhr->tyre_psi}} @endif" placeholder="Details"> </td>
                                </tr>

                                <tr>
                                    <td>LHF</td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][wheel_cylinders]" value="@if($document != null) {{$document->detail->lhf->wheel_cylinders}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][wheel_bearings]" value="@if($document != null) {{$document->detail->lhf->wheel_bearings}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][break_shoes]" value="@if($document != null) {{$document->detail->lhf->break_shoes}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][brake_magnet]" value="@if($document != null) {{$document->detail->lhf->brake_magnet}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][hub_wear]" value="@if($document != null) {{$document->detail->lhf->hub_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][tyre_wear]" value="@if($document != null) {{$document->detail->lhf->tyre_wear}} @endif" placeholder="Details"> </td>
                                    <td><input @if($document != null) disabled @endif type="text" name="document[detail][lhf][tyre_psi]" value="@if($document != null) {{$document->detail->lhf->tyre_psi}} @endif" placeholder="Details"> </td>
                                </tr>
